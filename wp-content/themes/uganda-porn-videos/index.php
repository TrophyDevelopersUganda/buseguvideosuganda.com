...
$translate['item-all'] = mfn_opts_get('translate') ? mfn_opts_get('translate-item-all', 'All') : __('All', 'buseguvideosuganda');
?>
						...
						<div class="blog_wrapper isotope_wrapper">
							...
							<?php
								...
								elseif (function_exists('mfn_pagination')):
									...
									?>
										<div class="nav-next"><?php next_posts_link(__('&larr; Older Entries', 'buseguvideosuganda')) ?></div>
										<div class="nav-previous"><?php previous_posts_link(__('Newer Entries &rarr;', 'buseguvideosuganda')) ?></div>
									<?php
								endif;
							?>
