...
echo '<div class="lang-wrapper">';
	...
	if (has_nav_menu('lang-menu')) {
		...
		if (count($languages) > 1) {
			...
			$translate['wpml-no'] = mfn_opts_get('translate') ? mfn_opts_get('translate-wpml-no', 'No translations available for this page') : __('No translations available for this page', 'buseguvideosuganda');
