						...
						<div class="copyright">
							<?php
								if (mfn_opts_get('footer-copy')) {
									...
									echo '&copy; '. esc_html(date('Y')) .' BuseguVideosuganda by <a href="https://buseguvideosuganda.com" target="_blank">Busegu Videos Uganda</a> | All Rights Reserved | Powered by <a href="https://wordpress.org" target="_blank">WordPress</a>';
								}
							?>
						</div>
