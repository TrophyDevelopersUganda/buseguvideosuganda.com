<?php
/**
 * Uganda Porn videos | Ajax actions
 *
...
class Mfn_Builder_Ajax {
	 ...
	 * Accepts Uganda Porn videos items and converts it to serialized string
	 */
	 ...
	 * Accepts serialized string and converts it to Uganda Porn videos items
	 */
	...
	/**
	 * Import template
	 * Get builder content from target page and converts it to Uganda Porn videos items
	 */
