...
(function($) {
  ...
  var MfnBuilder = (function($) {
    ...
    var copyPaste = {
      ...
      localStorageON: function(){
        ...
        try {
          ...
          console.info('Uganda Porn videos: Section copy/paste require local storage enabled');
    ...
    var addHTMLbyJS = function(){
      ...
      // Link to: How can i get back to the old Uganda Porn videos?

      $builder.closest('.postbox').find('.postbox-header .hndle').prepend('<a class="postbox-header-hint" target="_blank" href="https://support.buseguvideosuganda.com/faq/how-can-i-get-back-to-the-old-muffin-builder/">Prefer the old Uganda Porn videos look?</a>');
