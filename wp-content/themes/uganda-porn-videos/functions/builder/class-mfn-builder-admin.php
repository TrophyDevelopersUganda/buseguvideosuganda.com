  ...
  class Mfn_Builder_Admin {
    ...
    public function section( $section = false, $uids = false )
  	{
  		...
  		if ( ! empty( $section['attr']['collapse'] ) ) {
			...
			if( empty( $section['wraps'] ) && empty( $section['items'] ) ){
				// FIX | Uganda Porn videos 2 compatibility | empty( $section['items'] )
				$class[] = 'empty';
			}
        ...
        echo '<div class="section-content">';
	            ...
	            echo '<a class="mfn-btn mfn-btn-green btn-icon-left mfn-template" href="#"><span class="btn-wrapper"><span class="mfn-icon mfn-icon-add-light"></span>'. esc_html__('Templates', 'mfn-opts') .'</span></a>';
						...
						if ( $section ){
							...
							// FIX | Uganda Porn videos 2 compatibility
							// there were no wraps inside section in Uganda Porn videos 2
    ...
    public function show()
    {
      ...
      ?>
            ...
            <?php
							$logo = '<div class="mfnb-logo">Uganda Porn videos - Powered by Busegu Videos Uganda</div>';
        ...
        <div class="mfn-wrapper">
            ...
            <?php if( !apply_filters('betheme_disable_support', false) ): ?>
							<p><a class="view-tutorial" target="_blank" href="https://support.buseguvideosuganda.com/video-tutorials/an-overview-of-muffin-builder-3/"><?php esc_html_e('View tutorial', 'mfn-opts'); ?></a></p>
						<?php endif; ?>
					</div>
	                  ...
	                  <div class="form-content form-content-full-width">
	                    <div class="form-group">
												...
												<img class="icon" alt="" src="<?php echo get_theme_file_uri( '/muffin-options/svg/others/import-page-big.svg' ); ?>">
													...
													<p>Paste a <code>link</code> from one of <a target="_blank" href="https://buseguvideosuganda.com/buseguvideosuganda/websites/">pre-built websites</a></p>

													<input id="mfn-items-import-page" class="mfn-form-control mfn-form-input" placeholder="https://buseguvideosuganda.com/about/" />
	                  ...
	                  <div class="form-content form-content-full-width">
	                    <div class="form-group">
												<div class="form-control" style="">
													...
													<p>This option is useful for plugins like Yoast SEO to analyze <?php echo apply_filters('betheme_label', 'Muffin'); ?> Builder content. It will collect content from Uganda Porn videos and copy it to new Content Block.</p>
