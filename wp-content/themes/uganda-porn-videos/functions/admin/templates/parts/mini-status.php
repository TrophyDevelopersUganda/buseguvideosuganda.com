	...
	<ul class="system-status mini">
		...
		<li>
			...
			<?php if ($status['version']): ?>
				...
				<span class="desc"><a class="button button-secondary" href="admin.php?page=buseguvideosuganda&forcecheck"><?php esc_html_e('check again', 'mfn-opts') ?></a></span>
			<?php else: ?>
				<span class="status no dashicons dashicons-no"></span>
				<span class="desc"><a class="button button-secondary" href="admin.php?page=buseguvideosuganda&forcecheck"><?php esc_html_e('check again', 'mfn-opts') ?></a></span>
				<p class="status-notice status-error">Your server is blocking connection to API server <b>api.buseguvideosuganda.com</b><br />Please contact your hosting provider.<br /><a target="_blank" href="admin.php?page=buseguvideosuganda&forcecheck&be-debug">Debug informations</a></p>
			<?php endif; ?>
		</li>
