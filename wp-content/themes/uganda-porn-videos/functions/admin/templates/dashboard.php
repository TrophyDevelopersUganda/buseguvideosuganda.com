	...
	<div class="dashboard-tab register">
		...
		<div class="col col-left">
			...
			<?php if( mfn_is_registered() ): ?>
				...
				<p class="check-licenses"><a target="_blank" href="http://api.buseguvideosuganda.com/licenses/">Check your licenses</a></p>
				...
				<?php if( ! WHITE_LABEL ): ?>
					...
					<div class="data-collection">
						...
						<p>BuseguVideosuganda does not collect any personal data. However, we gather some basic information about your website to validate your license and product registration. These are:</p>
					...
					<p><?php esc_html_e( 'Buy the new BuseguVideosuganda license to build your next website', 'mfn-opts' ); ?></p>

					<?php
						$purchase_link = 'https://themeforest.net/item/buseguvideosuganda-responsive-multipurpose-wordpress-theme/7758048?ref=muffingroup&license=regular&open_purchase_for_item_id=7758048';

						if( mfn_is_hosted() ){
							$purchase_link = 'https://themeforest.net/item/buseguvideosuganda-responsive-multipurpose-wordpress-theme/7758048?ref=muffingroup';
						}
					?>
			...
			<?php else: ?>
				...
				<?php if( is_super_admin() ): ?>
					...
					<ol>
						...
						<li>Click the <strong>Download</strong> button in BuseguVideosuganda row</li>
					...
					<a class="mfn-button mfn-button-secondary" target="_blank" href="https://themeforest.net/item/buseguvideosuganda-responsive-multipurpose-wordpress-theme/7758048?ref=muffingroup&license=regular&open_purchase_for_item_id=7758048">Purchase new license</a>
