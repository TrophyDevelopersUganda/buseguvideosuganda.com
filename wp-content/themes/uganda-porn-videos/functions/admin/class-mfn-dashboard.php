...
class Mfn_Dashboard extends Mfn_API
{
	...
	public function __construct()
	{
		...
		// buseguvideosuganda admin before tabs
	...
	public function init()
	{
		...
		$title = array(
			'buseguvideosuganda'	=> apply_filters('betheme_dynamic_slug', 'buseguvideosuganda'),
			'dashboard'	=> __('Dashboard', 'mfn-opts'),
			'label' => apply_filters('betheme_label', 'BuseguVideosuganda')
		);
		...
		if (WHITE_LABEL) {
			$title['buseguvideosuganda'] = 'buseguvideosuganda';
			$title['label'] = 'Theme';
			$icon = false;
		}
	...
	public function after_switch_theme()
	{
		...
		wp_safe_redirect(admin_url('admin.php?page=buseguvideosuganda'));
	}
