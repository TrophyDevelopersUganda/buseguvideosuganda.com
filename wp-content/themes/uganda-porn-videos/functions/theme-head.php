...
if (! function_exists('mfn_styles_static')) {
	function mfn_styles_static()
	{
		if( mfn_opts_get( 'static-css' ) ){
			...
			$url = $upload_dir['baseurl'] .'/buseguvideosuganda/css/static.css';
	...
	function mfn_scripts()
	{
		...
		$config = array(
			...
			'livesearch' => array(
				...
				'translation' => array(
					'pages' => 		$is_translation_on ? mfn_opts_get('translate-livesearch-pages', 'Pages') : __('Pages','buseguvideosuganda'),
					'categories' => $is_translation_on ? mfn_opts_get('translate-livesearch-categories', 'Categories') : __('Categories','buseguvideosuganda'),
					'portfolio' =>  $is_translation_on ? mfn_opts_get('translate-livesearch-portfolio', 'Portfolio') : __('Portfolio','buseguvideosuganda'),
					'post' => $is_translation_on ? mfn_opts_get('translate-livesearch-posts', 'Posts') : __('Posts','buseguvideosuganda'),
					'products' => $is_translation_on ? mfn_opts_get('translate-livesearch-products', 'Products') : __('Products','buseguvideosuganda'),
				),
			),
