...
class Mfn_Importer {
	...
	function get_demo_url(){
		...
		if( 'theme' == $this->demo_builder ){
			...
			$url = 'https://buseguvideosuganda.com/buseguvideosuganda/';

		} elseif( 'bethemestore' == $this->demo_builder ){

			$url = 'https://buseguvideosuganda.com/buseguvideosuganda-store/';

		} elseif( 'bethemestore_el' == $this->demo_builder ){

			$url = 'https://buseguvideosuganda.com/buseguvideosuganda-store_el/';

		} else {

			$url = array(
				'http://themes.buseguvideosuganda.com/be/'. $this->demo_builder .'/',
				'https://buseguvideosuganda.com/be/'. $this->demo_builder .'/',
			);
	...
	function import_options( $file ){
		...
		if( is_array( $data ) ){
			...
			ob_start();
			update_option( 'buseguvideosuganda', $data );
			ob_end_clean();
	...
	/**
	 * Replace Uganda Porn videos URLs
	 *
	 * @param array $old_url
	 */
					...
					<?php if( ! $this->error ): ?>
						...
						<div class="import-all-done item" data-id="<?php echo esc_attr( $this->demo ); ?>">
							...
							<?php if( ! apply_filters('betheme_disable_support', false) ): ?>
								...
								<div class="done-help">
									<a target="_blank" href="https://buseguvideosuganda.com/documentation/">
											...
											echo '<div class="item-content-wrapper">';
												...
												echo '<div class="content-step step-1">';
													...
													if( ! empty( $demo['url'] ) ){
														...
														$demo_url = 'https://buseguvideosuganda.com/be/'. $key .'/';
														$demo_el = 'https://buseguvideosuganda.com/be/'. $key .'_el/';
													}
													...
													if( $builder_selector ){
														...
														echo '<ul class="select-builder clearfix">';
															...
															echo '<li class="muffin active" data-builder="">';
																echo '<span class="builder-title">Uganda Porn videos</span>';
														...
														if( mfn_is_registered() ){
															...
															echo '<a href="admin.php?page=buseguvideosuganda" class="mfn-button mfn-button-secondary">Please register the theme</a>';
														}
