...
if (! function_exists('sc_blog')) {
	function sc_blog($attr, $content = null)
	{
		...
		$translate['filter'] = mfn_opts_get('translate') ? mfn_opts_get('translate-filter', 'Filter by') : __('Filter by', 'buseguvideosuganda');
		$translate['tags'] = mfn_opts_get('translate') ? mfn_opts_get('translate-tags', 'Tags') : __('Tags', 'buseguvideosuganda');
		$translate['authors'] = mfn_opts_get('translate') ? mfn_opts_get('translate-authors', 'Authors') : __('Authors', 'buseguvideosuganda');
		$translate['all'] = mfn_opts_get('translate') ? mfn_opts_get('translate-item-all', 'All') : __('All', 'buseguvideosuganda');
		$translate['categories'] = mfn_opts_get('translate') ? mfn_opts_get('translate-categories', 'Categories') : __('Categories', 'buseguvideosuganda');
...
if (! function_exists('sc_countdown')) {
	function sc_countdown($attr, $content = null)
	{
		...
		$translate['days'] = mfn_opts_get('translate') ? mfn_opts_get('translate-days', 'days') : __('days', 'buseguvideosuganda');
		$translate['hours'] = mfn_opts_get('translate') ? mfn_opts_get('translate-hours', 'hours') : __('hours', 'buseguvideosuganda');
		$translate['minutes'] = mfn_opts_get('translate') ? mfn_opts_get('translate-minutes', 'minutes') : __('minutes', 'buseguvideosuganda');
		$translate['seconds']	= mfn_opts_get('translate') ? mfn_opts_get('translate-seconds', 'seconds') : __('seconds', 'buseguvideosuganda');
				...
				$output .= '<ul>';
					...
					foreach ( $mfn_tabs_array as $tab ) {
						...
						if (preg_match($pattern, $tab['content'])) {
							$tab['content'] = __('Tab shortcode does not work inside another tab.', 'buseguvideosuganda');
						}
...
if (! function_exists('sc_livesearch')) {
	function sc_livesearch($attr, $content = null)
	{
		...
		$translate['search-placeholder'] = mfn_opts_get('translate') ? mfn_opts_get('translate-search-placeholder','Enter your search') : __('Enter your search','buseguvideosuganda');
		$translate['livesearch-noresults'] = mfn_opts_get('translate') ? mfn_opts_get('translate-livesearch-noresults','Not found text') : __('Not found text','buseguvideosuganda');
		$translate['livesearch-button'] = mfn_opts_get('translate') ? mfn_opts_get('translate-livesearch-button','See all results') : __('See all results','buseguvideosuganda');
