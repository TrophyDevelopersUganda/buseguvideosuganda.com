...
if (! class_exists('Mfn_Post_Type_Template')) {
	class Mfn_Post_Type_Template extends Mfn_Post_Type
	{
		...
		public function productTemplateField($post) {
			echo '<p class="post-attributes-label-wrapper page-template-label-wrapper"><label class="post-attributes-label" for="mfn-template-choose">Uganda Porn videos Template</label></p>';
