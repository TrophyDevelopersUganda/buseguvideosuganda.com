		...
		echo '<div class="desc-group">';
			...
			if ( 'wpml' == $action ) {
				...
				echo '<span class="description">';
					...
					echo '<p>BuseguVideosuganda is <a href="https://wpml.org/theme/buseguvideosuganda/?aid=29349&affiliate_key=aCEsSE0ka33p" target="_blank">fully compatible with WPML</a> - the WordPress Multilingual Plugin. WPML lets you add languages to your existing sites and includes advanced translation management.</p>';
