...
class MFN_Options_upload_icon extends Mfn_Options_field
{
	...
	public function upload_icons()
	{
		...
		// rename and move to buseguvideosuganda icons upload dir

		$new_icon_path = $this->path_icons.'/' .$font_name_provided;
		$new_icon_url = wp_normalize_path( get_home_url() . '/wp-content/uploads/buseguvideosuganda/icons/' . $font_name_provided);
