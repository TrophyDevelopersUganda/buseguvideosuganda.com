...
if ( ! class_exists( 'MFN_Options' ) ) {
	...
	class MFN_Options
	{
		...
		public function __construct($menu = array(), $sections = array())
		{
			...
			$defaults['opt_name'] = 'buseguvideosuganda';
		...
		/**
		 * Backward compatibility with older BuseguVideosuganda versions
		 * @since 21.9.1
		 */
		...
		public function _options_page()
		{
			$this->page = add_submenu_page(
				apply_filters('betheme_dynamic_slug', 'buseguvideosuganda'),
			...
			echo '<div id="mfn-options" class="mfn-ui mfn-options loading">';
				...
				echo '<div class="mfn-mobile-header">';
					...
					echo '<div class="options-group logo-group">';
						...
						echo '<h4 class="title">Busegu Videos Uganda</h4>';
					echo '</div>';
				  ...
				  echo '</div>';
				    ...
				    echo '<div class="mfn-subheader mfn-shadow-1">';
				      ...
				      echo '<div class="subheader-options-group subheader-buttons">';
				        echo '<a class="mfn-btn mfn-btn-blank btn-only-icon" target="_blank" href="https://support.buseguvideosuganda.com/" data-tooltip="'. __('Help Center', 'mfn-opts'). '"><span class="btn-wrapper"><span class="mfn-icon mfn-icon-support"></span></span></a>';
								echo '<a class="mfn-btn mfn-btn-blank btn-only-icon" target="_blank" href="https://support.buseguvideosuganda.com/changelog/" data-tooltip="'. __('Changelog', 'mfn-opts'). '"><span class="btn-wrapper"><span class="mfn-icon mfn-icon-changelog"></span></span></a>';
				        // echo '<a class="mfn-btn mfn-btn-blank btn-only-icon" href="#" data-tooltip="Settings"><span class="btn-wrapper"><span class="mfn-icon mfn-icon-settings"></span></span></a>';
								...
								if( mfn_is_registered() ){
									...
									echo '<a href="admin.php?page=buseguvideosuganda" class="mfn-btn btn-save-changes">Register now</a>';
								}
							...
							if( $form_class ){
								echo '<div class="mfn-alert">';
									...
									echo '<div class="alert-content">';
										echo '<p>BuseguVideosuganda <a target="_blank" href="admin.php?page=be-header">Header Builder</a> plugin is <b>active</b>. Header related options are hidden.</p>';
									echo '</div>';
								echo '</div>';
							}
