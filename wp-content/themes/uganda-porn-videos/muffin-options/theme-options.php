		...
		$sections['advanced'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'type' => 'select',
					'title' => __( 'Uganda Porn videos visibility', 'mfn-opts' ),
					'options' => array(
				...
				array(
					...
					'options' => array(
						0 => __( 'Uganda Porn videos - WordPress Editor', 'mfn-opts' ),
						1 => __( 'WordPress Editor - Uganda Porn videos', 'mfn-opts' ),
					),
				),
				...
				array(
					...
					'desc' => __('Animations for <a href="https://buseguvideosuganda.com/be/theme/shortcodes/boxes-infographics/#counter" target="_blank">Counter</a> & <a href="https://buseguvideosuganda.com/be/theme/shortcodes/boxes-infographics/#quickfact" target="_blank">Quick fact</a> items', 'mfn-opts'),
					'options' => array(
				...
				array(
					...
					'options' => array(
						...
						'builder-preview' => __('Uganda Porn videos items preview', 'mfn-opts'),
				...
				array(
					'id' => 'builder-storage',
					'type' => 'select',
					'title' => __('Uganda Porn videos data storage', 'mfn-opts'),
				...
				array(
					...
					'desc' => __('If you use only Uganda Porn videos and do not want WordPress Editor to distract you, you can hide it.', 'mfn-opts'),
					'options' => array(
						'1' => __('Hide', 'mfn-opts'),
						'0' => __('Show', 'mfn-opts'),
					),
		...
		$sections['subheader'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'title' => __('Options', 'mfn-opts'),
					'options' => array(
						'breadcrumbs-link'	=> __('Last item in <b>Breadcrumbs</b> is link<span>does <b>not</b> work with <a href="https://support.buseguvideosuganda.com/documentation/shop-creation/" target="_blank">Shop</a> related pages</span>', 'mfn-opts'),
		...
		$sections['extras'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'sub_desc' => __('Widgetized area falling from the top on click. For more details, please <a href="https://support.buseguvideosuganda.com/how-to/how-to-configure-sliding-top/" target="_blank">read this article</a>', 'mfn-opts'),
					'join' => true,
				),
		...
		$sections['blog'] = array(
			...
			'fields'	=> array(
				...
				array(
					...
					'desc' => __('Custom layout for <b>all</b> single posts. For more details, please <a href="https://support.buseguvideosuganda.com/how-to/how-to-use-layouts/" target="_blank">read this article</a>', 'mfn-opts'),
					'class' => 'narrow',
					'before' => 'ID',
				),
		...
		$sections['portfolio'] = array(
			...
			'fields'	=> array(
				...
				array(
					...
					'type' => 'text',
					'title' => __('Layout ID', 'mfn-opts'),
					'desc' => __('Custom layout for <b>all</b> single portfolio projects. For more details, please <a href="https://support.buseguvideosuganda.com/how-to/how-to-use-layouts/" target="_blank">read this article</a>', 'mfn-opts'),
					'before' => 'ID',
					'class' => 'narrow',
				),
		...
		$sections['responsive'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'desc' => __( 'Choose where you want to have horizontal padding between <a href="https://support.buseguvideosuganda.com/documentation/sections/#sections" target="_blank">sections</a>', 'mfn-opts' ),
					'options' => array(
						'' => __( '- Default -', 'mfn-opts' ),
				...
				array(
					...
					'desc' => __( 'Choose if you want to move up <a href="https://support.buseguvideosuganda.com/documentation/sections/#wraps" target="_blank">wraps</a> on mobile devices', 'mfn-opts' ),
					'options' => array(
						'' => __( '- Default -', 'mfn-opts' ),
						'no-tablet' => __( 'Disable on tablet and mobile < 960px', 'mfn-opts' ),
		...
		$sections['seo'] = array(
			...
			'fields'	=> array(
				...
				array(
					...
					'desc' => __( 'Code will be included <b>before</b> the closing <b>&lt;/head&gt;</b> tag<br /><a href="https://support.buseguvideosuganda.com/faq/google-analytics-code-does-not-work/" target="_blank">Google Analytics code does not work?</a>', 'mfn-opts' ),
					'class' => 'form-content-full-width',
				),
		...
		$sections['font-family'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'desc' => __('Digits in some items, e.g. <a href="https://buseguvideosuganda.com/be/theme/shortcodes/boxes-infographics/#chart" target="_blank">Chart</a>, <a href="https://buseguvideosuganda.com/be/theme/shortcodes/boxes-infographics/#counter" target="_blank">Counter</a>, <a href="https://buseguvideosuganda.com/be/theme/shortcodes/content-elements/#howitworks" target="_blank">How it Works</a>, <a href="https://buseguvideosuganda.com/be/theme/shortcodes/boxes-infographics/#quickfact" target="_blank">Quick Fact</a>, <a href="https://buseguvideosuganda.com/be/theme/product/flying-ninja/" target="_blank">Single Product Price</a>', 'mfn-opts'),
					'std' => 'Poppins'
				),
		...
		$sections['font-custom'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'link' => 'https://support.buseguvideosuganda.com/how-to/how-to-add-custom-fonts/',
				),
		...
		$sections['translate-general'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'sub_desc' => __('Builder items & shortcodes: <a href="https://buseguvideosuganda.com/be/theme/shortcodes/boxes-infographics/#beforeafter" target="_blank">Before After</a>, <a href="https://buseguvideosuganda.com/be/theme/shortcodes/boxes-infographics/#countdown" target="_blank">Countdown</a>', 'mfn-opts'),
					'join' => true,
				),
